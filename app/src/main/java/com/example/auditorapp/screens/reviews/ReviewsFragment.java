...
public class ReviewsFragment extends BaseFragment<FragmentReviewsBinding, ReviewViewModel> {
    ...
    @Override
    protected FragmentReviewsBinding createBinding(
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        actionViewModel.getIsButtonClickLD().observe(getViewLifecycleOwner(), drawerTabs -> {
            NavController navController =
                    NavHostFragment.findNavController(ReviewsFragment.this);
        ...
        viewModel.getReviewLD().observe(getViewLifecycleOwner(), reviews ->
        ...
        binding.fabAddNew.setOnClickListener(v -> {
            NavController navController =
                    NavHostFragment.findNavController(ReviewsFragment.this);
            NavDirections action =
                    ReviewsFragmentDirections.actionReviewsFragmentToCreateReviewFragment();
            navController.navigate(action);
        });
        ...
        adapter.setOnReviewClick(objectId -> {
            NavController navController =
                    NavHostFragment.findNavController(ReviewsFragment.this);
            NavDirections action =
                    ReviewsFragmentDirections.actionReviewsFragmentToReviewDetailFragment(objectId);
            navController.navigate(action);
        });
